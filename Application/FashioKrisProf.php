...
<body>
	<div id="rectangle">
		...
		<div id="e30_4"><img src ="ellipsekw.png"></div>
	<div id ="e30_5">Kris Wu</div>
...
<div id="images">
  <div id="imagez">
    <img src="DrSU1wYU4AATLR4.jpg" style="width:165;height:340;cursor:pointer" 
    onclick="onClick(this)" class="w3-hover-opacity">
    <img src="DSiaPyxXUAECibr.jpg" style="width:165;height:340;cursor:pointer" 
    onclick="onClick(this)" class="w3-hover-opacity">
  </div>
<div id="imagez">
<img src ="DNma9KKVwAAuClJ.jpg"  style="width:165;height:340;cursor:pointer" 
    onclick="onClick(this)" class="w3-hover-opacity">
<img src ="un.jpg"  style="width:165;height:340;cursor:pointer" 
    onclick="onClick(this)" class="w3-hover-opacity">
    </div>
    <div id="imagez">
<img src ="unkwon.jpg"  style="width:165;height:340;cursor:pointer" 
    onclick="onClick(this)" class="w3-hover-opacity">
<img src ="80523651_2457120311271161_9077445244976362879_n.jpg"  style="width:165;height:340;cursor:pointer" 
    onclick="onClick(this)" class="w3-hover-opacity">
  </div>
