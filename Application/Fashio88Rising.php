...
<body>
	<div id="rectangle">
		...
		<div id="e30_4"><img src ="ellipseeyes1.png"></div>
	<div id ="e30_5">88 Rising</div>
...
<div id="images">
  <div id="imagez">
    <img src="rb.jpg" style="width:165;height:340;cursor:pointer" 
    onclick="onClick(this)" class="w3-hover-opacity">
    <img src="1517155792578-Screen-Shot-2018-01-28-at-155632.png.jpeg" style="width:165;height:340;cursor:pointer" 
    onclick="onClick(this)" class="w3-hover-opacity">
  </div>
<div id="imagez">
<img src ="dummy-interview-2017jpg.jpg"  style="width:165;height:340;cursor:pointer" 
    onclick="onClick(this)" class="w3-hover-opacity">
<img src ="IMG_9416.jpg"  style="width:165;height:340;cursor:pointer" 
    onclick="onClick(this)" class="w3-hover-opacity">
    </div>
    <div id="imagez">
<img src ="Keith-Ape1.jpg"  style="width:165;height:340;cursor:pointer" 
    onclick="onClick(this)" class="w3-hover-opacity">
<img src ="August08_HappyEndings_FinalCover-WEB-copy.jpg"  style="width:165;height:340;cursor:pointer" 
    onclick="onClick(this)" class="w3-hover-opacity">
  </div>
