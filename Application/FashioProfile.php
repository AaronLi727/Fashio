...
<body>
	<div id="rectangle">
		...
		<div id="e30_4"><img src ="ellipseeyes.png"></div>
...
<div id="images">
  <div id="imagez">
    <img src="pic1.jpg" style="width:165;height:340;cursor:pointer" 
    onclick="onClick(this)" class="w3-hover-opacity">
    <img src="pic2.jpg" style="width:165;height:340;cursor:pointer" 
    onclick="onClick(this)" class="w3-hover-opacity">
  </div>
<div id="imagez">
<img src ="pic3.jpg"  style="width:165;height:340;cursor:pointer" 
    onclick="onClick(this)" class="w3-hover-opacity">
<img src ="pic4.jpg"  style="width:165;height:340;cursor:pointer" 
    onclick="onClick(this)" class="w3-hover-opacity">
    </div>
    <div id="imagez">
<img src ="pic5.jpg"  style="width:165;height:340;cursor:pointer" 
    onclick="onClick(this)" class="w3-hover-opacity">
<img src ="pic6.jpg"  style="width:165;height:340;cursor:pointer" 
    onclick="onClick(this)" class="w3-hover-opacity">
  </div>
