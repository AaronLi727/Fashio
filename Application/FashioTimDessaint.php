<html>
<head>
<title> Tim Dessaint Profile </title>
<meta charset="utf-8">
...
<div id="images">
  <div id="imagez">
    <img src="87577584_2832777576814217_1361661329996660582_n.jpg" style="width:165;height:340;cursor:pointer" 
    onclick="onClick(this)" class="w3-hover-opacity">
    <img src="83333936_518642188856634_618350334942866486_n.jpg" style="width:165;height:340;cursor:pointer" 
    onclick="onClick(this)" class="w3-hover-opacity">
  </div>
<div id="imagez">
<img src ="79590866_381461019286168_630952522806198272_n.jpg"  style="width:165;height:340;cursor:pointer" 
    onclick="onClick(this)" class="w3-hover-opacity">
<img src ="67452516_2375327286018382_3136940182797086057_n.jpg"  style="width:165;height:340;cursor:pointer" 
    onclick="onClick(this)" class="w3-hover-opacity">
    </div>
    <div id="imagez">
<img src ="66243095_351284892222570_2520770567785894621_n.jpg" style="width:165;height:340;cursor:pointer" 
    onclick="onClick(this)" class="w3-hover-opacity">
<img src ="84580988_637075257053617_2439525613864945453_n.jpg"  style="width:165;height:340;cursor:pointer" 
    onclick="onClick(this)" class="w3-hover-opacity">
  </div>
<div id="modal01" class="modal" onclick="this.style.display='none'">
  <span class="w3-button w3-hover-red w3-xlarge w3-display-topright">&times;</span>
  <div class="w3-modal-content w3-animate-zoom">
    <img id="img01" style="width:375px; height:100% !important;display:block;">
  </div>
</div>
</div>
<script>
